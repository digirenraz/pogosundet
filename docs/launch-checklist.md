...
- [x] ~~Apply migration 018 (gyms) BEFORE merging `slice/gyms-database`~~ **applied 2026-06-10, PR #121 merged**. Remaining: seed gyms per [`docs/gyms-seeding.md`](gyms-seeding.md) — **incremental and non-blocking**: the autocomplete works with whatever rows exist, and auto-learn adds name-only rows from day one.
