...
| 2026-05-22 | Level field: replaced range slider with `<input type="number">` (1–80, `inputMode="numeric"`) | The slider was imprecise and frustrating on mobile — no way to type a specific value and the touch target was small. Plain number input is faster and more accurate. Clearing the field sets level to unset. |
